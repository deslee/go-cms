...
func RepoUpsertUser(ctx context.Context, db *sqlx.DB, obj models.User) error {
...
func RepoFindUserById(ctx context.Context, db *sqlx.DB, val string) (*models.User, error) {
	obj := models.User{}
...
func RepoUpsertSite(ctx context.Context, db *sqlx.DB, obj models.Site) error {
...
func RepoFindSiteById(ctx context.Context, db *sqlx.DB, val string) (*models.Site, error) {
	obj := models.Site{}
...
func RepoUpsertItem(ctx context.Context, db *sqlx.DB, obj models.Item) error {
...
func RepoFindItemById(ctx context.Context, db *sqlx.DB, val string) (*models.Item, error) {
	obj := models.Item{}
...
func RepoUpsertGroup(ctx context.Context, db *sqlx.DB, obj models.Group) error {
...
func RepoFindGroupById(ctx context.Context, db *sqlx.DB, val string) (*models.Group, error) {
	obj := models.Group{}
...
func RepoUpsertAsset(ctx context.Context, db *sqlx.DB, obj models.Asset) error {
...
func RepoFindAssetById(ctx context.Context, db *sqlx.DB, val string) (*models.Asset, error) {
	obj := models.Asset{}
...
func RepoUpsertSiteUser(ctx context.Context, db *sqlx.DB, obj models.SiteUser) error {
...
func RepoUpsertItemGroup(ctx context.Context, db *sqlx.DB, obj models.ItemGroup) error {
...
func RepoUpsertItemAsset(ctx context.Context, db *sqlx.DB, obj models.ItemAsset) error {
